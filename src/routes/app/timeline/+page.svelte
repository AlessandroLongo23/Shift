<script>
    ...
    import { ContractTypeMap } from '$lib/models/Position.svelte';
    import { Briefcase, Calendar, Banknote, Building2, Plus, RefreshCw, Clock, MapPin, FileText } from 'lucide-svelte';
